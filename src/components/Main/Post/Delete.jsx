...
function Delete(props) {
  ...
  return (
      <div className="align-self-center my-1">
          <button className="d-flex py-0 btn post-buttons" onClick={handleDeletePost}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="align-self-center bi bi-trash" viewBox="0 0 16 16">
